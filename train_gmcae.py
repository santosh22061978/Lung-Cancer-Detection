...
from model import GaussianMixtureCAE
...
def main():
    ...
    # --------- Data parameters
    checkpoints_path = 'c:\\CNN-Lungs\\LungCancerDetection\\scripts\\output'
    dataset_path = 'c:\\CNN-Lungs\\LungCancerDetection\\dataset\\npz_spacing1x1x1_kernel5_drop0.5p'
