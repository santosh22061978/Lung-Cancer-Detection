...
class GeneratorFactory:
    ...
    def build_predictor(self, dataset_path, subset):
    ...
    def build_input_predict(self, dataset_path):
        """Data generator for binary classification model.
        Reads from file and feed into the model one sample at a time.
        Args:
            dataset_path (str): path to array data (npz files)         
        """

        # Input data
        with np.load(dataset_path) as array_data:
            x = array_data['array_lungs']
